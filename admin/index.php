...
if ($_REQUEST['act'] == '') {
	...
	admin_priv('cloud_services');
	$Loaction = 'http://dsc.ecmoban.com/cloud/platform_rec.html';
	ecs_header('Location: ' . $Loaction . "\n");
	exit();
}
else if ($_REQUEST['act'] == 'best_recommend') {
	admin_priv('cloud_services');
	$Loaction = 'http://dsc.ecmoban.com/cloud/best_rec.html';
	ecs_header('Location: ' . $Loaction . "\n");
	exit();
}
